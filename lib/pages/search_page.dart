        ...
        child: ListView(
          children: [
            ...
            Wrap(
              ...
              runSpacing: 20,
              children: [
                CategoriesShow('Breakfast', 95.0),
                CategoriesShow('Fastfood', 90.0),
                CategoriesShow('Launch', 75.0),
                CategoriesShow('South Indian', 120.0),
                CategoriesShow('North Indian', 118.0),
                CategoriesShow('Dinner', 78.0),
                CategoriesShow('Pure Veg', 95.0),
                CategoriesShow('Non Veg', 92.0),
              ],
            ),
            SizedBox(
              height: 50,
